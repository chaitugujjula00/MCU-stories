  ...
  return (
    <header className="bg-black text-white p-3">
      <div className="container mx-auto flex justify-between items-center">
        <img className="text-2xl font-bold h-24 bg-black" src={LOGO_URL}></img>
        <nav className='w-[35%]'>
          <ul className="flex justify-between items-center">
            <li><a href="#" className="text-xl hover:underline">Movies</a></li>
            <li><a href="#" className="text-xl hover:underline">Upcoming</a></li>
            <li><a href="#" className="text-xl hover:underline">Characters</a></li>
          </ul>
        </nav>
